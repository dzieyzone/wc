...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $language->language; ?>" xml:lang="<?php print $language->language; ?>" class="bg" xmlns:og="http://opengraphprotocol.org/schema/">
  <head>
  ...
  <body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
    <div id="page" class="page row <?php print $grid_width; ?>">
        ...
        <div id="header-group-wrapper" class="header-group-wrapper full-width">
          <div id="header-group" class="header-group row">
            <div id="header-group-inner" class="header-group-inner inner clearfix">
              ...
              <div id="header-site" class="header-site-info block grid24-none">
    ...
    <script type="text/javascript">stLight.options({publisher: "ur-1ca0d428-10b3-3a29-a8e8-23d758e35b2a", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
  </body>
</html>